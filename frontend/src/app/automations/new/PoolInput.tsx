        ...
        <div className="flex flex-wrap">
            ...
            <div className="w-full lg:w-3/12 px-4">
                <div className="relative w-full mb-3">
                    <label htmlFor="network" className="block uppercase text-blueGray-600 text-sm font-bold mb-2">
                        Network
                    </label>
                    <input
                        type="text"
            ...
            <div className="w-full lg:w-3/12 pr-4">
                <div className="relative w-full mb-3">
                    <label htmlFor="exchange" className="block uppercase text-blueGray-600 text-sm font-bold mb-2">
                        Exchange
                    </label>
                    <input
                        type="text"
